...
public class PhoneUtil {
     ...
     * @return 手机号是否正确
     */
    public static boolean checkPhoneNumber(String mobileNumber, String lang) throws NumberParseException {
...
//            System.out.println(availableLocale.getCountry() + "---" + availableLocale.getLanguage());
//        }
        // CountryCode countryCode = CountryCode.getByLocale(Locale.CHINA);

        CountryCode[] values = CountryCode.values();
        for (CountryCode countryCode : values) {
            System.out.println(countryCode.getName() + "---" + countryCode.getAlpha2() + "---" + countryCode.getAlpha3() + "---" + countryCode.getCurrency() + "---" + countryCode.getNumeric());
        }
