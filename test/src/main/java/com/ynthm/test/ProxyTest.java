...
public class ProxyTest {
    ...
    static class UserProxy {
        public static UserService getUserProxy() {
            ...
            UserService userInterface = (UserService) Proxy.newProxyInstance(UserProxy.class.getClassLoader(),
    ...
    static class UserCglibProxy {
        ...
        public static UserService getUserProxy() {
            ...
            UserService userInterface = (UserService) net.sf.cglib.proxy.Proxy.newProxyInstance(

                    UserCglibProxy.class.getClassLoader(), new Class[]{UserService.class}, USER_HANDLE);
    ...
    private static void testCglibClassProxy() {
        User user = new User();
        user.setName("tom");
        UserServiceImpl userImpl = (UserServiceImpl) ClassCgLibProxy.getUserProxy(new UserServiceImpl());
